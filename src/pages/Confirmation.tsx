  ...
  <div class="receipt">
   ...
   return (
      <motion.div
         ...
         animate={{ opacity: 1 }}
         exit={{ opacity: 0 }}
         className="bg-[#0A0A0A] min-h-screen flex items-center justify-center pt-40 pb-20 px-4 md:px-8 text-gold-light font-sans selection:bg-gold/30"
      >
            ...
            >
               ...
               <div className="flex flex-col items-center gap-8 relative z-10">
                  ...
                  <div className="space-y-4">
                     <h1 className="text-4xl sm:text-5xl md:text-8xl font-serif tracking-tight text-gold-light">C'est <span className="italic font-light text-gold-light/30">Confirmé.</span></h1>
                  </div>
               </div>
               ...
               <div className="bg-[#121212] border border-white/5 p-8 sm:p-12 md:p-20 rounded-3xl shadow-2xl space-y-12 text-left relative overflow-hidden z-10">
                  <div className="absolute top-0 right-0 p-12 opacity-5 pointer-events-none text-gold-light hidden sm:block">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 relative z-10">
                     <div className="space-y-8">
                        <div className="space-y-2">
                           <span className="text-[10px] uppercase tracking-widest font-bold text-gold-light/30">Référence de réservation</span>
                           <p className="text-xl sm:text-2xl font-serif tracking-widest text-gold-light">{reference}</p>
                        </div>
                        <div className="space-y-2">
                           <span className="text-[10px] uppercase tracking-widest font-bold text-gold-light/30">Suite réservée</span>
                     ...
                     <div className="space-y-8">
                        <div className="flex items-start gap-4 sm:gap-6">
                           <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-white/5 flex items-center justify-center shrink-0">
                              <Mail size={18} className="text-gold-light/60" />
                           </div>
                           <div className="space-y-2">
                              <h4 className="text-[10px] sm:text-sm font-bold uppercase tracking-widest font-sans text-gold-light/60">Instructions par mail</h4>
                              <p className="text-xs sm:text-sm italic font-light text-gold-light/40 leading-relaxed">
                  ...
                  <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row items-center justify-end gap-8 text-center md:text-left">
                     ...
                     <button
                        ...
                        className="flex items-center justify-center md:justify-end gap-4 text-[10px] uppercase tracking-[0.4em] font-bold text-gold-light/40 hover:text-gold transition-colors cursor-pointer"
                     >
                        <Download size={16} />
